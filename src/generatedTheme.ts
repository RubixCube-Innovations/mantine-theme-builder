export const generatedTheme: any = {
  zinc: `import {
  alpha,
  Anchor,
  Button,
...
export const shadcnCssVariableResolver: CSSVariablesResolver = (theme) => ({
  variables: {
    ...
    "--mantine-primary-color-filled-hover": {{literal-open}}alpha("var(--mantine-primary-color-filled)", 0.9){{literal-close}},
    "--mantine-primary-color-light": "var(--mantine-color-dark-light)",
    "--mantine-primary-color-light-hover": {{literal-open}}alpha("var(--mantine-primary-color-light)", 0.8){{literal-close}},
  ...
  light: {
    ...
    "--mantine-color-dark-light-hover": {{literal-open}}alpha("var(--mantine-color-dark-light)", 0.8){{literal-close}}, // used as primary light hover color
  ...
  dark: {
    ...
    "--mantine-color-dark-filled-hover": {{literal-open}}alpha("var(--mantine-color-dark-filled)", 0.9){{literal-close}}, //used as secondary hover color
