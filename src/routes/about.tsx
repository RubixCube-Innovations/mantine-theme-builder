...
function RouteComponent() {
  return (
    ...
    >
      <Stack>
        <Group>
          <Button variant="filled" size="sm" component="a" href="https://www.linkedin.com/in/abhishekslal" target="_blank">
            Contact us
          </Button>
        ...
        <Space mb="xs" />
        <Box bd={"1px solid var(--mantine-color-default-border)"} p={"lg"} style={{borderRadius:"var(--mantine-radius-default)"}}>
        <AboutPage />
        </Box>
      </Stack>
    </PageLayout>
