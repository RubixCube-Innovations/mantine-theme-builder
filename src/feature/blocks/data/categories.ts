...
export const CATEGORIES: CategoriesGroup[] = [
  ...
  // },
  {
    ...
    categories: [
      ...
      { slug: "testimonials", name: "Testimonials", images: images.features },
      { slug: "faq", name: "FAQ", images: images.features },
      { slug: "pricing", name: "Pricing", images: images.features },
      { slug: "newsletter", name: "Newsletter", images: images.features },
