  ...
  return (
    <div
      className={clsx(
        ...
        size === "lg" ? (readMore ? "h-auto" : "h-[200vh] sm:h-[150vh] lg:h-[1200px] xl:h-[1100px]") : "",
        size === "md" ? (readMore ? "h-auto" : "h-[150vh] sm:h-[100vh] lg:h-[800px] xl:h-[700px]") : "",
        size === "sm" ? (readMore ? "h-auto" : "h-[100vh] sm:h-[50vh] lg:h-[600px] xl:h-[500px]") : ""
      )}
    >
      {children}
      ...
      {readMore ? null : (
        <>
          ...
          <div className="z-20 absolute bottom-12 left-0 right-0 flex justify-center items-center">
            <Button variant={variant} className="backdrop-blur-sm" onClick={() => setReadMore(true)}>
              {buttonLabel}
            </Button>
          </div>
        </>
...
export const LandingTestimonialReadMoreWrapper = ({
  ...
  return (
    <LandingReadMoreWrapper size={size} variant={variant} className={className} buttonLabel="Read more testimonials">
      {children}
