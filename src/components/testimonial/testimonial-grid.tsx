...
import { LandingTestimonial, TestimonialItem } from "./testimonial-item";
    ...
    >
      ...
      <div className="relative isolate">
            ...
            >
              <div
                className={clsx(
                  ...
                  backgroundGlowVariant === "primary" ? "from-primary-100 to-primary-200" : "",
                  backgroundGlowVariant === "secondary" ? "from-secondary-100 to-secondary-200" : ""
                )}
                style={{
                  clipPath:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            {featuredTestimonial ? (
              <LandingTestimonial featured {...featuredTestimonial} className="mb-4 columns-3xl" />
            ) : null}

            {testimonialItems.map((testimonial, index) => {
              return <LandingTestimonial className="mb-4" key={index} {...testimonial} />;
            })}
          </div>
        </div>
      </div>
