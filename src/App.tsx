      ...
      <Stack h={"100%"} w={"100%"}>
        <Group w={"100%"} justify="space-between" align="center" wrap="wrap">
          <Box>
            ...
            <Text>
              Shadcn inspired themes for <Anchor target="_blank" href="https://mantine.dev/">Mantine</Anchor> components that you can copy
              and paste into your apps.
            </Text>
          </Box>
          <Group>
            <Group gap={"0"}>
              <Button variant="subtle" size="xs" style={{ cursor: "pointer" }}>
                About
              </Button>
        ...
        <Box mt="auto" w="100%">
         ...
         <Group justify="space-between" align="center">
            <Text size="sm">
              This project is inspired by <Anchor
                href="https://ui.shadcn.com/themes"
                target="_blank"
                rel="noopener noreferrer"
              >Shadcn Themes.</Anchor>
